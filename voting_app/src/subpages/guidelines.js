            ...
            <div className="bg-gray-100 py-16">
                <div className="container mx-auto p-4">
                    ...
                    <div className="prose lg:prose-xl text-gray-700">
                        ...
                        <h2 className="text-2xl font-semibold mt-8 mb-4">How to Vote</h2>
                        <p>
                        ...
                        <h2 className="text-2xl font-semibold mt-8 mb-4">Rules and Punishments</h2>
                        <p>
                        ...
                        <p>
                            Violation of these rules may result in account suspension or other appropriate punishments as determined by our administrators.
                        </p>
